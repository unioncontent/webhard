...
// const aPath = '/home/hosting_users/otogreen/apps/otogreen_oto/';
// router.post('/file_upload',async function (req, res) {
//   var date = datetime.create();
//   var today = date.format('Ymd');
//   var time = date.format('HMS');
//   await mkdirsFun(aPath+'public/uploads/'+today);
//
//   var form = new multiparty.Form({
//       autoFiles: false, // 요청이 들어오면 파일을 자동으로 저장할 것인가
//       uploadDir: aPath+'public/uploads/'+today// 파일이 저장되는 경로(프로젝트 내의 temp 폴더에 저장됩니다.)
//   });
//
...
//       var path = aPath+'public/uploads/'+today+'/';
