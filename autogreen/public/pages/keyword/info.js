        ...
        var html = '<tr><th>'+numIdx+'</th>\
          ...
          <td class="text-center">\
            <div class="btn-group btn-group-md text-center" style="padding-right: 0; display: inline-block;">\
              <button type="button" class="btn-delete btn btn-danger waves-effect waves-light alert-confirm1" style="margin-right: 5px;" data-kidx="'+item.k_L_idx+'">\
                <span class="far fa-trash-alt"></span>\
              </button>\
              <button type="button" class="btn-edit btn btn-primary waves-effect waves-light" data-kidx="'+item.cnt_idx+'">\
